...
public class Main {
	...
	public static void main(String[] args) {
		...
		getStateMachine(umlP, "PackageStateMachine", "State");
	...
	public static void getStateMachine(Model uml, String packageContainerName, String classname) {
		Package currPackage = (Package) uml.getPackagedElement(packageContainerName);
		PackageableElement classElement = currPackage.getPackagedElement(classname);
		
		System.out.println(classElement.getOwnedElements());
	}
